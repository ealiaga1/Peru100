...
class PedidosController extends Controller {
    ...
    public function __construct() {
        parent::__construct();
        require_once ROOT_PATH . 'app/models/MesasModel.php';
    ...
    public function index() {
        ...
        $data['mesas'] = $this->mesasModel->getAllMesas(); // Obtener todas las mesas con su salón
    ...
    public function takeOrder($id_mesa) {
        ...
        if ($mesa['estado'] === 'Libre') {
            ...
            $this->mesasModel->updateMesaEstado($id_mesa, 'Ocupada'); // O 'En Pedido'
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($pedido_id) {
                ...
                if ($this->pedidoModel->addDetallesPedido($pedido_id, $productos_data)) {
                    ...
                    $this->mesasModel->updateMesaEstado($id_mesa, 'Ocupada');
