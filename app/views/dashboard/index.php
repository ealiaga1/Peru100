...
<body>
    <div class="container mt-5" style="margin-left: 250px;">
        ...
        <div class="row g-4 mb-4">
            <div class="col-md-4">
                <div class="card text-bg-primary">
                    <div class="card-body">
                        ...
                        <p class="card-text display-6">S/. 0.00</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="card text-bg-warning">
                    <div class="card-body">
                        <h5 class="card-title"><i class="bi bi-box me-2"></i>Inventario</h5>
                        <p class="card-text display-6">0</p>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title"><i class="bi bi-bar-chart-line me-2"></i>Gráfico de Ventas</h5>
